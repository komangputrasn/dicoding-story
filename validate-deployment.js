...
if (fs.existsSync(pushServicePath)) {
  ...
  const fixes = [
    {
      check: "Browser support check",
      pattern: /This browser does not support notifications/,
    },
    { check: "Permission denied handling", pattern: /permission was denied/ },
    {
      check: "Default permission handling",
      pattern: /permission === "default"/,
    },
    {
      check: "Enhanced error messages",
      pattern: /Please enable notifications in your browser/,
    },
  ];
...
console.log(
  "🧪 Test Page: https://dicoding-story-sandy.vercel.app/notification-test.html"
);
